...
$sql = "SELECT books.*,category.cat_name,author.au_name
FROM `books` 
LEFT JOIN category ON books.cat_id=category.cat_id LEFT JOIN author ON books.au_id=author.au_id;";
...
if ($result->num_rows > 0) {
 ...
 <td>
    <a href="view_explorebook.php?book_id=' . $row['book_id'] . '"><img src=../../assets\img\view.png> </a> 
    <a href="action/editbook.php?book_id=' . $row['book_id'] . '"><img src=../../assets\img\edit.png> </a> 
    <a href="action/deletebook.php?book_id=' . $row['book_id'] . '"><img src=../../assets\img\delete.png></a>
    </td>
    </tr>';
    }
...
<i class="icon fas fa-check"></i> Error </div>';
                ...
                if (isset($_GET['update']) && $_GET['update'] == 'Success') {
                    echo '<div class="alert alert-success alert-dismissible">
<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
<i class="icon fas fa-check"></i> Record has been updated successfully! </div>';
